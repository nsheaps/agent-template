<!-- Source: ~/src/nsheaps/ai/.ai/rules/never-say-done-prematurely.md -->
...
3. **Run a review pass** - Get systematic feedback on your implementation
...
4. Review        → Does the review find issues?
...
3. Running review... [addressing feedback]
