<!-- Source: ~/src/nsheaps/ai/.ai/rules/tool-preferences.md -->
...
3. Where possible, accompany scripts with documentation on usage
...
1. MCP server
2. CLI tooling
3. Scripts that capture complexity (but not secrets)
4. Direct API calls using `curl` or `wget`
